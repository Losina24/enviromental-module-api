...
class NotificationDatabaseHandler {
    ...
    queryResultsToEnviromentalDevices(results) {
        ...
        results.forEach((element) => {
            ...
            notification.setName(element.name);
            notification.setMac(element.identifier);
            notification.setGatewayId(element.gateway_id);
            notification.setCoords([element.latitude, element.longitude]);
            notification.setStatus(element.status);
     ...
     * @returns
     */
    getNotificationByUserIdFromDB(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            var query = "SELECT notification.* FROM user_device INNER JOIN sensor ON user_device.device_id=sensor.device_id INNER JOIN notification ON sensor.id=notification.sensor_id WHERE user_device.user_id = " + userId + ";";
     ...
     * @returns
     */
    getSensorNotificationsFromDB(userId) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.default = NotificationDatabaseHandler;
